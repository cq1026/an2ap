            ...
            return (
                <div className="page-container animate-fade-in">
                    ...
                    <div className="flex justify-between items-center mb-6" style={{ marginTop: '24px', flexWrap: 'wrap', gap: '12px' }}>
                        <div className="search-container" style={{ flex: '1', minWidth: '200px', maxWidth: '400px', position: 'relative' }}>
                    ...
                    {/* Mobile Card View */}
                    <div className="logs-mobile-view" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                        {filteredLogs.length === 0 ? (
                            <Card>
                                ...
                                {filteredLogs.map((log, index) => {
                                    ...
                                    return (
                                        <Card key={index} style={{ padding: '16px' }}>
                                            ...
                                            <div style={{ fontSize: '12px', color: 'var(--zinc-500)', fontFamily: 'monospace', marginBottom: '8px' }}>
                                                {time}
                                            </div>
                                            <div
                                                className="font-mono"
